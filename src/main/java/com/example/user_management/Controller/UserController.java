...
import com.example.user_management.Service.UserService; // The service layer class that UserController interacts with.
...
public class UserController {
  private final UserService userService;// Declares a final field of type UserService, which will handle business logic and database interactions.
  @Autowired
